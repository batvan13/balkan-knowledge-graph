    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.entities.contacts.update', [$entity, $contact]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex items-center gap-2 mb-6">
                        ...
                        <input type="checkbox" name="is_primary" value="1" id="edit_is_primary"
                               @checked(old('is_primary', $contact->is_primary))
                               class="rounded border-gray-300 text-gray-800">
                        <label for="edit_is_primary" class="text-xs font-medium text-gray-600 select-none">Primary</label>
                    </div>
